    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleSection}>
        ...
        <Text style={styles.subtitleText}>
          Select a route to view live map tracking, arrival times, and delays.
        </Text>
      </View>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity 
            ...
            onPress={() => router.push({
              ...
              params: { selectedBus: item.name } // 🚀 Directly opens the Live Map Tracking View
            })}
          >
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontWeight: '700', color: '#046A38', letterSpacing: 0.5 },
  titleSection: { paddingHorizontal: 24, marginTop: 20, marginBottom: 15 },
  mainTitleText: { fontSize: 28, fontWeight: '800', color: '#045028', letterSpacing: -0.5 },
  subtitleText: { fontSize: 13, color: '#718096', lineHeight: 18, marginTop: 6, fontWeight: '500' },
  listContainer: { paddingHorizontal: 20, paddingTop: 10, paddingBottom: 30 },
  routeItemCard: { backgroundColor: '#F7FAFC', borderRadius: 14, padding: 16, marginBottom: 12, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderWidth: 1, borderColor: '#EDF2F7' },
  cardLeftContent: { flexDirection: 'row', alignItems: 'center', flex: 1, marginRight: 10 },
  iconContainer: { backgroundColor: '#FFFFFF', padding: 10, borderRadius: 12, borderWidth: 1, borderColor: '#E2E8F0', marginRight: 14 },
  metaTextData: { flex: 1 },
  routeName: { fontSize: 15, fontWeight: '700', color: '#1A202C' },
  routeDesc: { fontSize: 12, color: '#718096', marginTop: 2, fontWeight: '500' },
  statusBadgeWrapper: { flexDirection: 'row', alignItems: 'center' },
  statusLabelText: { fontSize: 11, color: '#4A5568', fontWeight: '700', marginRight: 8 },
